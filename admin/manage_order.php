...
?>
    ...
    <h1 class="py-4" style="padding: 0 0 40px 0;">Manage Order</h1>
    ...
    $sql="Select * from tbl_order";
      ...
      foreach($datas as $data){
        ...
        echo "<td class='space'>"; echo $data["food"]; echo "</td>";
        echo "<td class='space'>"; echo $data["price"]; echo "</td>";
        echo "<td class='space'>"; echo $data["quantity"]; echo "</td>";
        echo "<td class='space'>"; echo $data["total"]; echo "</td>";
        echo "<td class='space'>"; echo $data["order_date"]; echo "</td>";
        echo '<td>';
        if($data["status"] == "Ordered"){
            echo '<strong><p >'.$data["status"].'</p></strong>';
        }
        ...
        echo "<td class='space'>"; echo $data["customer_address"]; echo "</td>";
          
          echo "<td> <a class='btn btn-info' href='./update_order.php?update=".$data['id']."'> Update</a> </td>";
